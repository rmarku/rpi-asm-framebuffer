...
* El archivo _main.s_ contiene la inicialización del FrameBuffer y el puerto UART, al finalizar llama a _app.s_ **(NO EDITAR)**
...
* **[start.s](start.s)** Este archivo realiza la inicialización del hardwar _(tanto framebuffer como uart)_
